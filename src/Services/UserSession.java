...
public class UserSession {
    ...
    public static void setProfilepicture(String profilepicture){ UserSession.profilepicture= profilepicture; }
    public static String getProfilepicture() { return profilepicture; }

    public static String getName() { return name; }
    public static String getAftername() { return aftername; }
